"""
Django settings for tddtshtch_dev_121203 project.
...
ROOT_URLCONF = 'tddtshtch_dev_121203.urls'
...
WSGI_APPLICATION = 'tddtshtch_dev_121203.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tddtshtch_dev_121203 API",
    "DESCRIPTION": "API documentation for tddtshtch_dev_121203 App",
    "VERSION": "v1",
}
